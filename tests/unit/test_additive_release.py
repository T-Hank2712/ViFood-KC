...
def test_build_release_creates_functions_and_aliases() -> None:
    candidates = [{"label": "Additive", "id": "ADDITIVE:INS_621", "properties": {
        "name": "Monosodium L-glutamate", "name_vi": "Bột ngọt", "ins": "621",
        "functional_classes": ["Chất điều vị"],
    }}]
...
def test_rejects_ambiguous_aliases() -> None:
    candidate = {"label": "Additive", "id": "ADDITIVE:INS_621", "properties": {"name": "x", "name_vi": "x", "ins": "621", "functional_classes": []}}
    with pytest.raises(ValueError, match="Ambiguous"):
        build_release([candidate, {"label": "Additive", "id": "ADDITIVE:INS_621_DUPLICATE", "properties": {"name": "y", "name_vi": "y", "ins": "621", "functional_classes": []}}], "2026-06-22")
